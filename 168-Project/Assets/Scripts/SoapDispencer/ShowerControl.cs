...
public class ShowerControl : MonoBehaviour
{
    ...
    void Start()
    {
        shower = GameObject.Find("Obi shower");
        shower.GetComponent<ObiEmitter>().speed = 2;
    ...
    void Update()
    {
        ...
        {
            shower.GetComponent<ObiEmitter>().speed = 0;
        }
    }

    void OnTriggerEnter(Collider other)
    {
        pumpingTimer = timeDispence;
        shower.GetComponent<ObiEmitter>().speed = 3;
    }
